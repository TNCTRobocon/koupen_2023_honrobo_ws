class JoyCalcTools():
    ...
    def recaluculating_joy(self,joy):
        ...
        if self.__PC == 0:
            ###Potable-PC
            recaluculated_joy[0] = joy.axes[1] * 127 + 128
            recaluculated_joy[1] = joy.axes[0] * 127 + 128
            recaluculated_joy[2] = joy.axes[4] * -127 + 128
            recaluculated_joy[3] = joy.axes[3] * -127 + 128
